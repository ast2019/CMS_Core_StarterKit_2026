...
return [
     ...
     *
     * The spec is COMMITTED at this path and OpenApiSpecIsInSyncTest fails the build
     * when it drifts from what the code produces. Committing it is what turns rule
     * #3 from a convention into a gate: a reviewer sees the spec diff in the same
     * pull request as the route change, and CI refuses a change that forgot it.
     */
     ...
     */
         ...
         */
        'description' => 'Delivery API (public, read-only, cached) and Management API '
        .'(Sanctum, admin-scoped). All routes are versioned under /api/v1/.',
    ],
