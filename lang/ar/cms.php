...
return [
    ...
    'ai_translation' => [
        'confirm' => 'ستُترجَم الحقول النصية لهذا المحتوى من الفارسية إلى هذه اللغة وتُحفظ كترجمة آلية. لا يُترجَم النص الغني (متن المحتوى) ويجب إدخاله يدويًا. تحتاج النتيجة إلى مراجعة قبل النشر.',
