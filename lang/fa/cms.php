...
return [
    ...
    'ai_translation' => [
        'confirm' => 'فیلدهای متنی این مطلب از فارسی به این زبان ترجمه و در وضعیت «ترجمهٔ ماشینی» ذخیره می‌شوند. متن غنی (بدنهٔ مطلب) ترجمه نمی‌شود و باید دستی وارد شود. نتیجه پیش از انتشار نیاز به بازبینی دارد.',
